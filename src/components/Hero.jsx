...
function Hero() {
  return (
    <div>
        ...
        <div className='content--section max-w-[1644px] mx-auto  grid grid-cols-3 h-72 bg-purple-900 px-32 items-center'>
            <div className='box w-96 m-10'>
                ...
                <button className='bg-purple-600 border-2 border-purple-600 hover:bg-purple-700 hover:border-2 hover:border-white px-8 py-[8px] rounded-lg text-white text-lg'>Contact Us</button>                
            </div>
            <div className='box w-80 m-10'>
                ...
                <button className='bg-purple-600 border-2 border-purple-600 hover:bg-purple-700 hover:border-2 hover:border-white px-8 py-[8px] rounded-lg text-white text-lg'>View Flipbooks</button>                
            </div>
            <div className='box w-80 m-10'>
                <div className='mb-4 gap-2'>
                ...
                <button className='bg-purple-600 border-2 border-purple-600 hover:bg-purple-700 hover:border-2 hover:border-white px-8 py-[8px] rounded-lg text-white text-lg'>View Videos</button>                
            </div>
        </div>
    </div>
  )
